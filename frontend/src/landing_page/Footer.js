    ...
    return ( 
      ...
      <div className="container border-top mt-5">
        <div className="row mt-5">
          <div className="col">
            <img src="media/logo.svg" alt="Company Logo" style={{ width: "50%" }} />
            <p>
          ...
          <div className="col">
            ...
            <br />
            <a href="/referral-programme">Referral programme</a>
            <br />
          ...
          <div className="col">
            ...
            <br />
            <a href="/z-connect-blog">Z-Connect blog</a>
            <br />
            <a href="/list-of-charges">List of charges</a>
            <br />
          ...
          <div className="col">
            ...
            <br />
            <a href="/60-day-challenge">60 day challenge</a>
            <br />
          </div>
        </div>
